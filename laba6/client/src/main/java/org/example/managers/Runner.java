            ...
            while (running){
                ...
                switch (response.getStatus()){
                    case ASK_ORGANISATION -> {
                        ...
                        client.sendData(new Request (userCommand[0].trim(), userCommand[1].trim(), organisation));
                    ...
                    case ASK_ADDRESS -> {
                        ...
                        client.sendData(new Request (userCommand[0].trim(), address));
                        Response newResponse = client.readData();
            ...
            while (commandStatus && console.getScanner().hasNext() && (line = console.getScanner().nextLine()) != null){
                ...
                switch (response.getStatus()){
                    case ASK_ORGANISATION -> {
                        ...
                        client.sendData(new Request(scriptCommand[0].trim(), scriptCommand[1].trim(), organisation));
                        Response newResponse = client.readData();
